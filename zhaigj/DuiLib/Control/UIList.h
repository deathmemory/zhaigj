...
public:
	...
	void SetTextStyle(int iIndex,DWORD style);
	DWORD GetTextStyle(int iIndex);
...
public:
	...
	BOOL CanSelected(){return m_bCanSel;};

	void SetCanSelect(BOOL bCanSel){ m_bCanSel = bCanSel;};
