...
namespace DuiLib
{
	...
	void CScrollBarUI::SetStatusImage(LPCTSTR pStrImage ,int btnWidth,int btnHeight)
	{
		CString strThumbNormalImage	;
		CString strThumbHotImage;
		CString strThumbPushedImage;
		CString strThumbDisabledImage;

		CString strRailNormalImage;
		CString strRailHotImage;
		CString strRailPushedImage;
		CString strRailDisabledImage;

		CString strBkNormalImage;
		CString strBkHotImage;
		CString strBkPushedImage;
		CString strBkDisabledImage;

		CString strButton1NormalImage;
		CString strButton1HotImage;
		CString strButton1PushedImage;
		CString strButton1DisabledImage;

		CString strButton2NormalImage;
		CString strButton2HotImage;
		CString strButton2PushedImage;
		CString strButton2DisabledImage;
		...
		{
			strThumbNormalImage		.Format(_T("file='%s' source='%d,%d,%d,%d' corner='0,2,0,2'"),pStrImage,0*btnWidth +0 ,7*btnHeight + 7,1*btnWidth+0,8*btnHeight + 7);
			strThumbHotImage		.Format(_T("file='%s' source='%d,%d,%d,%d' corner='0,2,0,2'"),pStrImage,1*btnWidth +1 ,7*btnHeight + 7,2*btnWidth+1,8*btnHeight + 7);
			strThumbPushedImage		.Format(_T("file='%s' source='%d,%d,%d,%d' corner='0,2,0,2'"),pStrImage,2*btnWidth +2 ,7*btnHeight + 7,3*btnWidth+2,8*btnHeight + 7);
			strThumbDisabledImage	.Format(_T("file='%s' source='%d,%d,%d,%d' corner='0,2,0,2'"),pStrImage,3*btnWidth +3 ,7*btnHeight + 7,4*btnWidth+3,8*btnHeight + 7);
																						 	 
			strRailNormalImage		.Format(_T("file='%s' source='%d,%d,%d,%d' corner='0,2,0,2'"),pStrImage,0*btnWidth +0 ,8*btnHeight + 8,1*btnWidth+0,9*btnHeight + 8);
			strRailHotImage			.Format(_T("file='%s' source='%d,%d,%d,%d' corner='0,2,0,2'"),pStrImage,1*btnWidth +1 ,8*btnHeight + 8,2*btnWidth+1,9*btnHeight + 8);
			strRailPushedImage		.Format(_T("file='%s' source='%d,%d,%d,%d' corner='0,2,0,2'"),pStrImage,2*btnWidth +2 ,8*btnHeight + 8,3*btnWidth+2,9*btnHeight + 8);
			strRailDisabledImage	.Format(_T("file='%s' source='%d,%d,%d,%d' corner='0,2,0,2'"),pStrImage,3*btnWidth +3 ,8*btnHeight + 8,4*btnWidth+3,9*btnHeight + 8);

			strBkNormalImage		.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,0*btnWidth +0 ,9*btnHeight + 9,1*btnWidth+0,10*btnHeight + 9);
			strBkHotImage			.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,1*btnWidth +1 ,9*btnHeight + 9,2*btnWidth+1,10*btnHeight + 9);
			strBkPushedImage		.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,2*btnWidth +2 ,9*btnHeight + 9,3*btnWidth+2,10*btnHeight + 9);
			strBkDisabledImage		.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,3*btnWidth +3 ,9*btnHeight + 9,4*btnWidth+3,10*btnHeight + 9);
																			                   
			strButton1NormalImage	.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,0*btnWidth +0 ,5*btnHeight + 5,1*btnWidth+0,6*btnHeight + 5 );
			strButton1HotImage		.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,1*btnWidth +1 ,5*btnHeight + 5,2*btnWidth+1,6*btnHeight + 5 );
			strButton1PushedImage	.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,2*btnWidth +2 ,5*btnHeight + 5,3*btnWidth+2,6*btnHeight + 5 );
			strButton1DisabledImage	.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,3*btnWidth +3 ,5*btnHeight + 5,4*btnWidth+3,6*btnHeight + 5 );
																			                   
			strButton2NormalImage	.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,0*btnWidth +0 ,6*btnHeight + 6,1*btnWidth+0,7*btnHeight + 6);
			strButton2HotImage		.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,1*btnWidth +1 ,6*btnHeight + 6,2*btnWidth+1,7*btnHeight + 6);
			strButton2PushedImage	.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,2*btnWidth +2 ,6*btnHeight + 6,3*btnWidth+2,7*btnHeight + 6);
			strButton2DisabledImage	.Format(_T("file='%s' source='%d,%d,%d,%d'                 "),pStrImage,3*btnWidth +3 ,6*btnHeight + 6,4*btnWidth+3,7*btnHeight + 6);
		}

		SetThumbNormalImage(	strThumbNormalImage			);
		SetThumbHotImage(		strThumbHotImage			);
		SetThumbPushedImage(	strThumbPushedImage			);
		SetThumbDisabledImage(	strThumbDisabledImage		);

		SetRailNormalImage(		strRailNormalImage			);
		SetRailHotImage(		strRailHotImage				);
		SetRailPushedImage(		strRailPushedImage			);
		SetRailDisabledImage(	strRailDisabledImage		);

		SetBkNormalImage(		strBkNormalImage			);
		SetBkHotImage(			strBkHotImage				);
		SetBkPushedImage(		strBkPushedImage			);
		SetBkDisabledImage(		strBkDisabledImage			);

		SetButton1NormalImage(	strButton1NormalImage		);
		SetButton1HotImage(		strButton1HotImage			);
		SetButton1PushedImage(	strButton1PushedImage		);
		SetButton1DisabledImage(strButton1DisabledImage		);

		SetButton2NormalImage(	strButton2NormalImage		);
		SetButton2HotImage(		strButton2HotImage			);
		SetButton2PushedImage(	strButton2PushedImage		);
		SetButton2DisabledImage(strButton2DisabledImage	);
	}
		...
		if( event.Type == UIEVENT_MOUSEMOVE )
		{
			...
			if( (m_uThumbState & UISTATE_CAPTURED) != 0 ) {
				if( !m_bHorizontal ) {
					...
					int vRange = m_rcItem.bottom - m_rcItem.top - m_rcThumb.bottom + m_rcThumb.top - nBtnWitdh;
					...
					int hRange = m_rcItem.right - m_rcItem.left - m_rcThumb.right + m_rcThumb.left - nBtnWitdh;
