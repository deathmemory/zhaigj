...
public:
	...
	static TImageInfo* LoadImage(UINT bitmap, LPCTSTR type = NULL, HMODULE hRes = NULL);
    static void DrawImage(HDC hDC, HBITMAP hBitmap, const RECT& rc, const RECT& rcPaint, const RECT& rcBmpPart, const RECT& rcCorners, BOOL alphaChannel, BYTE uFade = 255, BOOL hole = FALSE, BOOL xtiled = FALSE, BOOL ytiled = FALSE);
    static BOOL DrawImageString(HDC hDC, CPaintManagerUI* pManager, const RECT& rcItem, const RECT& rcPaint, LPCTSTR pStrImage,UINT nImageID = 0, LPCTSTR pStrModify = NULL);
    ...
    static void DrawHtmlText(HDC hDC, CPaintManagerUI* pManager, RECT& rc, LPCTSTR pstrText, 
        DWORD dwTextColor, RECT* pLinks, CString* sLinks, int& nLinkRects, UINT uStyle,int nLinkUnder = 0);
