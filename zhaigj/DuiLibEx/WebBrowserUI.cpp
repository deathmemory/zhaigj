...
void DuiLib::CWebBrowserUI::Navigate2( LPCTSTR lpszUrl,LPCTSTR lpszPost  )
{
	if (lpszUrl == NULL)
		return;
...
LRESULT DuiLib::CWebBrowserUI::MessageHandler(LPMSG lpMsg, BOOL& bHandled)
  {
	  TranslateAccelerator(lpMsg);
	  return CActiveXUI::MessageHandler(lpMsg,bHandled);
  }
